#ifndef __FAS_FHSJ_JB_QBL_MN300_H__
#define __FAS_FHSJ_JB_QBL_MN300_H__

#include "Fas.h"
#include "Common.h"


class FasFHSJ_JB_QBL_MN300 : public Fas
{
public:
    FasFHSJ_JB_QBL_MN300(void);
    ~FasFHSJ_JB_QBL_MN300(void);
    bool init(int nType,
...
#endif //__FAS_FHSJ_JB_QBL_MN300_H__
